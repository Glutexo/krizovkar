...
Tyto pokyny platí pro celý repozitář a pro lidi i automatizované nástroje.

- Před úpravou si přečti `README.md` a `CONTRIBUTING.md`.
...
- Bez výslovného pokynu nepřepisuj zveřejněnou historii, nepoužívej force push a nemaž vzdálené větve.
- Zachovej licenci CC0-1.0 a nepřidávej závislosti nebo obsah s nekompatibilní licencí.
- Neupravuj ani nezahrnuj nesouvisející lokální změny uživatele.
